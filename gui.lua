...
title = "Bypass Anti-Cheat" --upper title
loading_text = "Please wait!" --gray title
loadingtime = "9" --loading time (in seconds)
...
title = "Just a moment" --upper title
loading_text = "This may take up to 2 minutes." --gray title
loadingtime = "5" --loading time (in seconds)
...
title = "Pre loading script" --upper title
loading_text = "Please wait, it won't take long." --gray title
loadingtime = "19" --loading time (in seconds)
